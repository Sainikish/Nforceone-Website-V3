...
export function FeatureCarousel({
  ...
  return (
    <div className="w-full max-w-7xl mx-auto md:p-8">
      <div className="relative overflow-hidden rounded-[2.5rem] lg:rounded-[4rem] flex flex-col lg:flex-row min-h-[460px] lg:aspect-[16/8] border border-border/40">
        <div
          className="w-full lg:w-[40%] min-h-[280px] md:min-h-[340px] lg:h-full relative z-30 flex flex-col items-start justify-center overflow-hidden px-8 md:px-16 lg:pl-16"
        ...
        <div className="flex-1 min-h-[360px] md:min-h-[420px] lg:h-full relative bg-secondary/30 flex items-center justify-center py-8 md:py-12 lg:py-8 px-6 md:px-12 lg:px-10 overflow-hidden border-t lg:border-t-0 lg:border-l border-border/20">
